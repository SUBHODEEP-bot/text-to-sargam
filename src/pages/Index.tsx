...
const Index = () => {
  ...
  return <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-accent/20 rounded-full blur-3xl animate-pulse-slow" style={{
        animationDelay: "1.5s"
      }} />
        ...
        <div className="relative container mx-auto px-4 py-8 md:py-16 max-w-6xl">
          ...
          <div className="text-center space-y-4 md:space-y-6 mb-8 md:mb-12">
            ...
            <h1 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-primary via-primary-glow to-accent bg-clip-text text-transparent gradient-animate px-4 break-words w-full font-serif lg:text-4xl">
              Sargam Sound Wave
            </h1>
          ...
          <Card className="max-w-3xl mx-auto p-4 md:p-8 shadow-card backdrop-blur-sm bg-card/95 border-2 hover:shadow-glow transition-all duration-300">
            <div className="space-y-4 md:space-y-6">
              <div className="space-y-2 md:space-y-3">
                ...
                <Input id="textInput" type="text" placeholder="Type a name or word..." value={inputText} onChange={e => setInputText(e.target.value)} className="text-base md:text-lg h-12 md:h-14 border-2 focus:border-primary transition-all" disabled={isPlaying} />
          ...
          {/* Conversion Display */}
          {conversionSteps.length > 0 && <div className="max-w-3xl mx-auto mt-6 md:mt-12 animate-fade-in">
          ...
          <div className="max-w-3xl mx-auto mt-8 md:mt-16">
            <Card className="p-4 md:p-8 bg-gradient-to-br from-card to-muted/30 border-2 border-primary/10 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                ...
                num: "1",
                title: "Text to ASCII",
                desc: "Characters → Numbers"
              }, {
                num: "2",
                title: "ASCII to Binary",
                desc: "Numbers → 8-bit Binary"
              }, {
                num: "3",
                title: "Binary Groups",
                desc: "Split into 3-bit chunks"
              }, {
                num: "4",
                title: "To Decimal",
                desc: "Groups → 0-7 values"
              }, {
                num: "5",
                title: "Sargam Mapping",
                desc: "Values → Musical notes"
              }, {
                num: "6",
                title: "Audio Synthesis",
                desc: "Notes → Sound waves"
              }].map(step => <div key={step.num} className="flex gap-3 p-3 md:p-4 rounded-lg bg-gradient-to-br from-background to-muted/50 hover:shadow-card transition-all hover:scale-105 border border-border/50">
